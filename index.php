...
<html lang="en">
  <head>
    ...
    <title>Jessica Landberg - Barnskötare</title>
  ...
  <body>
  	...
  	<nav role="main" class="hidden-print">
  		<ul>
  			...
  			<li><a class="scrollable" href="#utbildning">Utbildning</a></li>
  			<li><a class="scrollable" href="#arbete">Erfarenheter</a></li>
  			<li><a class="scrollable" href="#kontakt">Kontakt</a></li>
